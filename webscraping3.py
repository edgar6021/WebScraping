...
# Extraer las fechas de las temporadas del encabezado de la tabla
header = table.find('tr', {'class': 'table-index'})
seasons = [td.text.strip() for td in header.find_all('td')[2:]]
...
with open('Jugadore2.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
    writer.writerow(['Nombre', 'Salario Promedio'] + seasons)
